 ...
 * and userRouter click the back button after form submission, user-typed input can
...
/**
 * For userRouter typing via certain IMEs, queries must be triggered by intervals,
 ...
 * to trigger a query via interval for certain IME userRouter.
 *
