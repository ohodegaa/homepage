...
var jenkins = require('./util/jenkins');
var pluginManager = require('./apiRouter/pluginManager');
var securityConfig = require('./apiRouter/securityConfig');
...
exports.testConnectivity = function(siteId, handler) {
	// check the connectivity apiRouter
